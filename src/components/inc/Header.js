        ...
        <section className="top-bar-blink top-banner wcc mobile ">
          <div className="container text-white">
            <div className="py-1 divWcc">
              ...
              <div  style={{ display : "flex", justifyContent: "space-between", height: "2rem",alignItems: "center" }}>
              ...
              <div className="saleSection" style={{ paddingTop: "0", marginLeft: "5px",paddingLeft: "5px"}}>
                <a
                  className="text-white saleText"
                  href="#"
                >
              ...
              <div className="helpSection" style={{ display: "flex", alignItems: "center" }}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="30.31"
                  height="28.5"
